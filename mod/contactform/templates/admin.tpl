...
{block name='webpage_body'}
	...
	<fieldset>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="apikey" value="{if isset($config.key)}{$config.key}{/if}" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">{t d="contactform" m="Recaptcha Private Key"}</label>
			<div class="controls">
				<input type="text" id="privateKey" value="{if isset($config.privateKey)}{$config.privateKey}{/if}" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">{t d="contactform" m="Mail subject"}</label>
			<div class="controls">
				<input type="text" id="mailSubject" value="{if isset($config.mailSubject)}{$config.mailSubject}{/if}" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">{t d="contactform" m="Mail address for sender"}</label>
			<div class="controls">
				<input type="text" id="sender" value="{if isset($config.sender)}{$config.sender}{/if}" />
			</div>
		</div>
