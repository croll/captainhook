...
var User = new Class({
	...
	setUser: function(resJSON,uid) {
		...
		myForm.adopt(mynRow);
	 	...
	 	var myfnRow = new Element('div', {'class': 'clearfix'});
		...
		var myemRow = new Element('div', {'class': 'clearfix'});
		...
		var mypwRow = new Element('div', {'class': 'clearfix'});
		...
		var mywpRow = new Element('div', {'class': 'clearfix'});
